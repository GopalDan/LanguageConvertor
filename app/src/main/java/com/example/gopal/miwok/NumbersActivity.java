...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<Word> numbersList;
        ...
        if (selectedLanguage.equals(MainActivity.BENGALI)) {
            numbersList = Utility.getNumbersListForBengali();

        } else {
            numbersList = Utility.getNumbersListForHindi();

        }


        WordAdapter adapter = new WordAdapter(this, numbersList,R.color.number_catagory_color);
        ListView list = findViewById(R.id.list);
        list.setAdapter(adapter);
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Word currentWord = numbersList.get(i);
